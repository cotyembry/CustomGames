...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Ball = __webpack_require__(168);

	var _Ball2 = _interopRequireDefault(_Ball);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	_reactDom2.default.render(_react2.default.createElement(_Ball2.default, null), document.getElementById('Ball'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Ball = _react2.default.createClass({
		...
		ballMoving: function ballMoving() {
			...
			if (this.customState.calibrateXMovement - circle.getBBox().width / 2 <= 0) {
				...
				//self.topRightRebound(circle, this.calibrateXMovement, this.calibrateYMovement);
				//got hit on the top left for this case
		...
		calculateHit: function calculateHit(e) {
			var self = this;
			...
			switch (self.customState.positionOfContact === "" ? self.positionOfContact(e) : self.customState.positionOfContact) {
				case 'top-right':
					...
					self.customState.priorIntervalId = setInterval(function () {
						...
						self.component.addEventListener('move', function (e) {
							self.ballMoving();
						}, false);
		...
		positionOfContact: function positionOfContact(e) {
		...
		render: function render() {
			...
			return _react2.default.createElement(
				'svg',
				{ style: svgStyle },
				_react2.default.createElement('circle', { key: '1', id: 'circle', fill: 'purple', ref: function ref(c) {
						return _this.component = c;
					}, onClick: this.onClick, onMouseEnter: this.mouseEnter, onMouseLeave: this.mouseLeave, r: '40', cy: '100', cx: '100' })
			);
		},
		bottomLeftRebound: function bottomLeftRebound(circle, calibrateXMovement, calibrateYMovement) {
			var self = this;
			customState.priorIntervalId = setInterval(function () {
		...
		bottomRightRebound: function bottomRightRebound(circle, calibrateXMovement, calibrateYMovement) {
			var self = this;
			customState.priorIntervalId = setInterval(function () {
				calibrateXMovement += 3;
				calibrateYMovement -= 3;
		...
		topRightRebound: function topRightRebound(circle, calibrateXMovement, calibrateYMovement) {
			var self = this;
			customState.priorIntervalId = setInterval(function () {
